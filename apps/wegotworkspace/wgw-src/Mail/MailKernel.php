 ...
 *
 * Source: {@code packages/mail-ui/}; build output: {@code wgw-modules/mail/dist/}.
 */
final class MailKernel
{
    ...
    private static function respondDistMissing(string $webBase): void
    {
        ...
        echo '<p>Source lives in <code>packages/mail-ui/</code>; the Vite build writes to <code>wgw-modules/mail/dist/</code>.</p>';
