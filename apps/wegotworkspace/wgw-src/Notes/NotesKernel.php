...
final class NotesKernel
{
    ...
    private static function respondDistMissing(string $webBase): void
    {
        ...
        echo '<h1>Notes</h1>';
        echo '<p>The Notes UI build is missing. From the project root, run <code>pnpm --filter @wgw/notes-ui build</code> or <code>pnpm build</code>.</p>';
        echo '<p>Source lives in <code>packages/notes-ui/</code>; the Vite build writes to <code>wgw-modules/notes/dist/</code>.</p>';
