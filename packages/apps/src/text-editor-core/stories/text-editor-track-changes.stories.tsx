  ...
  return (
    <div className="docs-workspace flex min-h-[min(900px,90dvh)] flex-col p-6">
      <p className="mb-3 text-sm text-muted-foreground">
        Switch to <strong>Suggest</strong>, edit the document, then accept or reject proposals.
        Pending suggestions stay in the Yjs sidecar; saved markdown reflects accepted content only.
      </p>
      <DocsCollabEditor
        ydoc={session.ydoc}
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Offline Yjs-backed Docs editor with MIT `tiptap-track-changes` — edit/suggest toggle and accept/reject controls.",
      },
    },
  },
