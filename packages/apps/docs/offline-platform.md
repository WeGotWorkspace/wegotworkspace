...
- **Pending badge:** poll your "pending" selector and render a dot. Docs home surfaces auto-sync availability/pending badges on drive rows via optional `drive-browser` props.
