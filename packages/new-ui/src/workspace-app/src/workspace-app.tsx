...
import { AppSidebarScrim } from "@/app-sidebar/src/app-sidebar";
...
const DETAIL_SCROLL =
  "min-h-0 flex-1 overflow-y-auto px-6 md:px-12 py-10 md:py-16";
 ...
 */
export const WorkspaceApp = forwardRef<WorkspaceAppHandle, WorkspaceAppProps>(
  function WorkspaceApp(
    ...
    return (
      <TooltipProvider delayDuration={tooltipDelayDuration}>
        <WorkspaceAppLayout
          style={workspaceRoot.style}
          className={workspaceRoot.className}
        >
          {sidebar(chrome)}
          <AppSidebarScrim open={sidebarOpen} onClick={closeSidebar} />
