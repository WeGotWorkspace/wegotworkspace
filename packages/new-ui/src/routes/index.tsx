    ...
    >
      <section className="flex flex-col min-h-screen">
        <header className="px-8 pt-8 flex items-center gap-2">
          <span className="sr-only">WeGotWorkspace</span>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-md">
            <h2
              ...
              className="text-7xl md:text-8xl leading-[0.95] tracking-tight mb-12"
            >
              Welcome Back
            </h2>
            ...
            >
              <div>
                ...
                <input
                  ...
                  onBlur={(e) => (e.currentTarget.style.borderColor = "var(--color-ghost)")}
                />
              </div>
              ...
              <button
                ...
                style={{
                  ...
                  fontFamily: "var(--font-sans)",
                  boxShadow: "0 10px 30px -10px color-mix(in oklab, var(--color-forest) 60%, transparent)",
                }}
              >
                Sign in
              </button>
        ...
        <footer
          className="px-8 pb-6 flex items-center justify-between text-xs"
          style={{ color: "var(--color-slate-muted)" }}
        >
          <span>© 2026 WeGotWorkspace</span>
        </footer>
      </section>
    </main>
  );
