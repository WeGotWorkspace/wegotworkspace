...
import * as ModuleExports from "../components/ui/radio-group";
...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Auto-generated export inventory story for `radio-group`.",
      },
    },
  },
};
...
export const Exports: Story = {
  render: () => (
    <div style={{ minWidth: 320, maxWidth: 680 }}>
      <h3 style={{ fontWeight: 600, marginBottom: 8 }}>radio-group</h3>
