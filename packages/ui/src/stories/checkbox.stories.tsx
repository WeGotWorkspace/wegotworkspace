...
import * as ModuleExports from "../components/ui/checkbox";
...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Auto-generated export inventory story for `checkbox`.",
      },
    },
  },
};
...
export const Exports: Story = {
  render: () => (
    <div style={{ minWidth: 320, maxWidth: 680 }}>
      <h3 style={{ fontWeight: 600, marginBottom: 8 }}>checkbox</h3>
