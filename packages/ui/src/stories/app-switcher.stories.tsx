...
import * as ModuleExports from "../components/app-switcher";

const meta: Meta = {
  title: "app/app-switcher",
  parameters: {
    docs: {
      description: {
        component: "Auto-generated export inventory story for `app-switcher`.",
      },
    },
  },
};
...
export const Exports: Story = {
  render: () => (
    <div style={{ minWidth: 320, maxWidth: 680 }}>
      <h3 style={{ fontWeight: 600, marginBottom: 8 }}>app-switcher</h3>
