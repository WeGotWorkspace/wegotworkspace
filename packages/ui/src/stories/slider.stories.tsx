...
import * as ModuleExports from "../components/ui/slider";
...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: "Auto-generated export inventory story for `slider`.",
      },
    },
  },
};
...
export const Exports: Story = {
  render: () => (
    <div style={{ minWidth: 320, maxWidth: 680 }}>
      <h3 style={{ fontWeight: 600, marginBottom: 8 }}>slider</h3>
