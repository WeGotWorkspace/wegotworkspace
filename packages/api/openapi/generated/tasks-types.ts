...
export type TaskItemQueryFilter = components["schemas"]["TaskItemQueryFilter"];
export type TaskItemQueryRequest = components["schemas"]["TaskItemQueryRequest"];
export type TaskItemQueryResponse = components["schemas"]["TaskItemQueryResponse"];
export type TaskList = components["schemas"]["TaskList"];
export type TaskListCreate = components["schemas"]["TaskListCreate"];
export type TaskListDeleteOptions = components["schemas"]["TaskListDeleteOptions"];
export type TaskListPatch = components["schemas"]["TaskListPatch"];
