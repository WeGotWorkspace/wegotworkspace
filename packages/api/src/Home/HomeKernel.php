...
final class HomeKernel
{
    ...
    private static function respondDistMissing(string $webBase): void
    {
        ...
        echo '<h1>Home</h1>';
        echo '<p>The Home UI build is missing. From the project root, run <code>pnpm --filter @wgw/apps build</code> or <code>pnpm build</code>.</p>';
        echo '<p>Source lives in <code>packages/apps/</code>; app builds write to <code>packages/apps/home/dist/</code>.</p>';
