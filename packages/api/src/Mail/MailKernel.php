 ...
 *
 * Source: {@code packages/apps/}; build output: {@code wgw-modules/mail/dist/}.
 */
final class MailKernel
{
    ...
    private static function respondDistMissing(string $webBase): void
    {
        ...
        echo '<p>Source lives in <code>packages/apps/</code>; app builds write to <code>wgw-modules/mail/dist/</code>.</p>';
