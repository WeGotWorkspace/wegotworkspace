 ...
 *
 * Source: {@code packages/new-ui/}; build output: {@code wgw-modules/mail/dist/}.
 */
final class MailKernel
{
    ...
    private static function respondDistMissing(string $webBase): void
    {
        ...
        echo '<h1>Mail</h1>';
        echo '<p>The Mail UI build is missing. From the project root, run <code>pnpm --filter @wgw/new-ui build</code> or <code>pnpm build</code>.</p>';
        echo '<p>Source lives in <code>packages/new-ui/</code>; app builds write to <code>wgw-modules/mail/dist/</code>.</p>';
