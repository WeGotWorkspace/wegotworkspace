...
final class OfficeStatic
{
    public static function tryServe(string $webBase, string $path): bool
    {
        ...
        // Next static export may ship x2t.wasm as Brotli-compressed bytes (see packages/onlyoffice-web/next.config
     ...
     * The ONLYOFFICE Web export stores Brotli-compressed wasm under the {@code .wasm} name.
     */
