...
final class OpenApiDocument
{
    ...
    private static function ensureComponentSchemas(array &$schemas): void
    {
        $defs = [
            ...
            'InstallerBootstrapResponse' => ['type' => 'object', 'properties' => ['state' => ['type' => 'object']]],
            'InstallerStateResponse' => ['type' => 'object', 'properties' => ['installed' => ['type' => 'boolean'], 'maintenance' => ['type' => 'boolean'], 'state' => ['type' => 'object']]],
            'InstallerActionResponse' => ['type' => 'object', 'properties' => ['ok' => ['type' => 'boolean'], 'error' => ['type' => 'string'], 'redirect' => ['type' => 'string'], 'state' => ['type' => 'object']]],
            ...
            'AdminUserCreateRequest' => ['type' => 'object', 'properties' => ['username' => ['type' => 'string'], 'password' => ['type' => 'string'], 'displayName' => ['type' => 'string'], 'email' => ['type' => 'string'], 'groups' => ['type' => 'array', 'items' => ['type' => 'string']]], 'required' => ['username', 'password'], 'example' => ['username' => 'alice', 'password' => 'strong-password', 'displayName' => 'Alice', 'email' => 'alice@example.test', 'groups' => ['principals/groups/support']]],
            'AdminUserUpdateRequest' => ['type' => 'object', 'properties' => ['displayName' => ['type' => 'string'], 'email' => ['type' => 'string'], 'password' => ['type' => 'string'], 'groups' => ['type' => 'array', 'items' => ['type' => 'string']]], 'example' => ['displayName' => 'Alice Cooper', 'email' => 'alice@example.test', 'groups' => ['principals/groups/support']]],
            ...
            'AdminGroupUpdateRequest' => ['type' => 'object', 'properties' => ['displayName' => ['type' => 'string'], 'members' => ['type' => 'array', 'items' => ['type' => 'string']]], 'example' => ['displayName' => 'Support Team', 'members' => ['alice', 'bob']]],
            'AdminSettingsSaveRequest' => ['type' => 'object', 'properties' => ['values' => ['type' => 'object']], 'example' => ['values' => ['timezone' => 'UTC']]],
            'AdminStateResponse' => ['type' => 'object', 'properties' => ['users' => ['type' => 'array', 'items' => ['type' => 'object']], 'groups' => ['type' => 'array', 'items' => ['type' => 'object']], 'mail' => ['type' => 'object'], 'voice' => ['type' => 'object'], 'apps' => ['type' => 'object'], 'webdav' => ['type' => 'object'], 'updates' => ['type' => 'object'], 'currentUser' => ['type' => 'string'], 'logoutUrl' => ['type' => 'string']]],
