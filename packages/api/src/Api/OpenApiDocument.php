...
final class OpenApiDocument
{
    ...
    private static function ensureComponentSchemas(array &$schemas): void
    {
        $defs = [
            ...
            'UpdateApplyResponse' => ['type' => 'object', 'properties' => ['ok' => ['type' => 'boolean'], 'version' => ['type' => 'string'], 'message' => ['type' => 'string'], 'finishedAt' => ['type' => ['string', 'null']]], 'required' => ['ok', 'version', 'message', 'finishedAt']],
            ...
            'UpdateLogClearResponse' => ['type' => 'object', 'properties' => ['ok' => ['type' => 'boolean'], 'lines' => ['type' => 'array', 'items' => ['type' => 'string']]], 'required' => ['ok', 'lines']],
