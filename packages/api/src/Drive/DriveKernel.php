...
final class DriveKernel
{
    ...
    private static function respondDistMissing(string $webBase): void
    {
        ...
        echo '<h1>Drive</h1>';
        echo '<p>The Drive UI build is missing. From the project root, run <code>pnpm --filter @wgw/new-ui build</code> or <code>pnpm build</code>.</p>';
        echo '<p>Source lives in <code>packages/new-ui/</code>; app builds write to <code>wgw-modules/drive/dist/</code>.</p>';
