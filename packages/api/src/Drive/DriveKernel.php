...
final class DriveKernel
{
    ...
    private static function respondDistMissing(string $webBase): void
    {
        ...
        echo '<h1>Drive</h1>';
        echo '<p>The Drive UI build is missing. From the project root, run <code>pnpm --filter @wgw/drive build</code> or <code>pnpm build</code>.</p>';
        echo '<p>Source lives in <code>packages/drive/</code>; the Vite build writes to <code>wgw-modules/drive/dist/</code>.</p>';
